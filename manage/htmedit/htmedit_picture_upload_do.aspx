<% @page language="c#" inherits="cnfly_htmedit_picture_upload_do" %>
<% string pub_limit = ""; %>
...
if(intreturn == 0)
{
	Response.Write("<script>alert('文件上传成功！'); window.location='htmedit_picture.aspx?key=" + objinfo["key"] + "';</script>");
}
else if(intreturn == 2)
{
